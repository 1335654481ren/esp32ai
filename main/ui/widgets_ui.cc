...
void lv_demo_widgets(lv_obj_t* container)
{
...
static void color_event_cb(lv_event_t * e)
{
    ...
    if(code == LV_EVENT_FOCUSED) {
        ...
        lv_palette_t palette_secondary = (lv_palette_t)((int)(*palette_primary) + 3); /*Use another palette as secondary*/
...
static void meter1_indic1_anim_cb(void * var, int32_t v)
{
    lv_meter_set_indicator_end_value(meter1, (lv_meter_indicator_t *)var, v);
...
static void meter3_anim_cb(void * var, int32_t v)
{
    lv_meter_set_indicator_value(meter3, (lv_meter_indicator_t *)var, v);
